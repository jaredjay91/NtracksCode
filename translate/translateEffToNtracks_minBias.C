...
void translateEffToNtracks_minBias(){

/*  TString inFileName = "OtaFiles_2021_06_07/PbPbZ_tnp_Ana_MC_L3Mu12_PbPb_0_v5_paperFixedBWn.root";
  TString outFileName = "newFiles_minBias/PbPbZ_tnp_Ana_MC_L3Mu12_PbPb_0_v5_paperFixedBWn_Ntracks.root";
...
/*
  ...
  TString outFileName = "newFiles_minBias/PbPbZ_tnp_Ana_MC_MuId_PbPb_paper_0_Ntracks.root";
  TString treeTag = "tpTree";
  const static int numdirs = 1;
...
/*
  ...
  TString outFileName = "newFiles_minBias/PbPbZ_tnp_Ana_RD_L3Mu12_PbPb_0_v5_paperFixedBWn_Ntracks.root";
  TString treeTag = "tpTree";
  const static int numdirs = 1;
  TString centTag[numdirs] = {"Trg_centdep"};
  TString ntracksTag[numdirs] = {"Trg_ntracksdep"};
...
/*
  ...
  TString outFileName = "newFiles_minBias/PbPbZ_tnp_Ana_RD_MuId_PbPb_paper_0_Ntracks.root";
  TString treeTag = "tpTree";
  const static int numdirs = 1;
  TString centTag[numdirs] = {"MuId_centdep"};
  TString ntracksTag[numdirs] = {"MuId_ntracksdep"};
...
/*
  ...
  TString outFileName = "newFiles_minBias/PbPbZ_tnp_Z_MC_Trk_PbPb_paper_0_Ntracks.root";
...
*/
  ...
  TString outFileName = "newFiles_minBias/PbPbZ_tnp_Z_RD_Trk_PbPb_paper_0_Ntracks.root";
  TString treeTag = "tpTreeTrk";
  const static int numdirs = 2;
  TString centTag[numdirs] = {"Trk_centdep", "Trk_centdep_noTC"};
  TString ntracksTag[numdirs] = {"Trk_ntracksdep", "Trk_ntracksdep_noTC"};
