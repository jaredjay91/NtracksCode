...
void translateEffToNtracks_Ztriggered(){


  TString inFileName = "OtaFiles_2021_06_14/PbPbZ_tnp_Ana_MC_MuId_paper.root";
  TString outFileName = "newFiles_triggered/PbPbZ_tnp_Ana_MC_MuId_paper_Ntracks.root";
...
/*
  TString inFileName = "OtaFiles_2021_06_14/PbPbZ_tnp_Ana_RD_MuId_paper.root";
  TString outFileName = "newFiles_triggered/PbPbZ_tnp_Ana_RD_MuId_paper_Ntracks.root";
  TString treeTag = "tpTree";
  const static int numdirs = 1;
  TString centTag[numdirs] = {"MuId_centdep"};
  TString ntracksTag[numdirs] = {"MuId_ntracksdep"};
...
*/
/*
  TString inFileName = "OtaFiles_2021_06_14/PbPbZ_tnp_Ana_MC_Trigger_paper.root";
  TString outFileName = "newFiles_triggered/PbPbZ_tnp_Ana_MC_Trigger_paper_Ntracks.root";
  TString treeTag = "tpTree";
  const static int numdirs = 1;
...
*/
/*
  TString inFileName = "OtaFiles_2021_06_14/PbPbZ_tnp_Ana_RD_Trigger_paper.root";
  TString outFileName = "newFiles_triggered/PbPbZ_tnp_Ana_RD_Trigger_paper_Ntracks.root";
  TString treeTag = "tpTree";
  const static int numdirs = 1;
  TString centTag[numdirs] = {"Trg_centdep"};
  TString ntracksTag[numdirs] = {"Trg_ntracksdep"};
...
*/
/*
  TString inFileName = "OtaFiles_2021_06_14/PbPbZ_tnp_MC_Trk_paper.root";
  TString outFileName = "newFiles_triggered/PbPbZ_tnp_MC_Trk_paper_Ntracks.root";
...
*/
/*
  TString inFileName = "OtaFiles_2021_06_14/PbPbZ_tnp_RD_Trk_paper.root";
  TString outFileName = "newFiles_triggered/PbPbZ_tnp_RD_Trk_paper_Ntracks.root";
  TString treeTag = "tpTreeTrk";
  const static int numdirs = 2;
  TString centTag[numdirs] = {"Trk_centdep", "Trk_centdep_noTC"};
  TString ntracksTag[numdirs] = {"Trk_ntracksdep", "Trk_ntracksdep_noTC"};
...
*/
  ...
  for (int idir=0; idir<numdirs; idir++) {
    ...
    for (int jBin=0; jBin<nBins; jBin++){
      ...
      double eyl = Graph->GetErrorYlow(jBin);
      double effY = 0;
      double effX = 0;
      ntracksval = 0;
      ntrackserrlo = 0;
